...
class MainCollectionViewData {
    ...
    static func dataProvider() -> [ (IndexTitle, [CurrencyModel] ) ] {
        ...
        //=======Gold========
        arrayOfGold.append(CurrencyModel(currencyIcon: UIImage(named: "gold"), fullCurrencyTitle: "Silver", currencyTitle: "XAG", previousRate: "Silver", upToDateRate: "11"))
        arrayOfGold.append(CurrencyModel(currencyIcon: UIImage(named: "gold"), fullCurrencyTitle: "Gold", currencyTitle: "XAU", previousRate: "222", upToDateRate: "222"))
